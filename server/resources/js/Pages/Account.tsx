...
export default function Account({ auth }) {
    return (
        <Authenticated user={auth.user}>
            <div className="dark:!bg-navy-800 shadow-shadow-500 shadow-3xl rounded-primary relative  flex h-full w-full  flex-col items-center bg-white bg-cover bg-clip-border p-[16px] dark:text-white dark:shadow-none">
